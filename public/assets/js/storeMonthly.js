$(document).ready(function() {
      ...
      function monthlyUsageSubmit(event) {
          event.preventDefault();    
          ...
          insertMonthlyUsage({
            ...
            users:users.total,
            pageviewsBySession:roundTwoDecimal.round(pageviewsPerSession.total, 2),
            exitRate:roundTwoDecimal.round(exitRate.total,2),
            bounceRate:roundTwoDecimal.round(bounceRate.total,2),
            newSession:roundTwoDecimal.round(percentNewSessions.total,2),
            avgSession:roundTwoDecimal.round(avgSessionDuration.total, 2),
            channel:'Total',
      ...
      function insertMonthlyUsage(monthUsage) {
          $.post('/monthUsage/new', monthUsage);
      }
